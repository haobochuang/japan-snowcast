...
const RESORTS = [
  ...
  },
  {
    ...
    stats: {
      ...
      openRuns: 28, totalRuns: 30,
      lifts: { open: 13, total: 17 },
      condition: 'Packed Powder', windKph: 22, visibility: 'Good', tempC: -7
    },
    forecast: [
      { day:'Mon', icon:'🌨', snow:14, high:-5, low:-10, desc:'Snow' },
      { day:'Tue', icon:'🌨', snow:20, high:-6, low:-11, desc:'Heavy snow' },
      { day:'Wed', icon:'⛅', snow:4,  high:-4, low:-9,  desc:'Clearing' },
      { day:'Thu', icon:'☀️', snow:0,  high:-2, low:-7,  desc:'Sunny' },
      { day:'Fri', icon:'🌨', snow:10, high:-5, low:-10, desc:'Snow' },
    ],
    weeklySnow: [14, 20, 4, 0, 10, 8, 16],
    website: 'https://www.princehotels.com/kagura',
    notes: 'Japan\'s longest ski season — open until May. Connected to Naeba by the famous Dragondola gondola.',
  },
  {
    id: 22, rank: '#22',
    name: 'GALA Yuzawa', nameJP: 'ガーラ湯沢スキー場',
    region: 'honshu', prefecture: 'Niigata',
    lat: 36.9100, lon: 138.8100,
    elevation: { base: 430, summit: 1181 },
    photo: '',
    bgGradient: 'linear-gradient(135deg,#0a2040,#102850)',
    stats: {
      baseDepth: 90, summit48h: 18, base48h: 14,
      openRuns: 18, totalRuns: 18,
      lifts: { open: 7, total: 9 },
      condition: 'Groomed', windKph: 18, visibility: 'Good', tempC: -5
    },
    forecast: [
      { day:'Mon', icon:'🌨', snow:8,  high:-3, low:-8,  desc:'Snow' },
      { day:'Tue', icon:'🌨', snow:12, high:-4, low:-9,  desc:'Heavy snow' },
      { day:'Wed', icon:'⛅', snow:2,  high:-2, low:-7,  desc:'Clearing' },
      { day:'Thu', icon:'☀️', snow:0,  high:0,  low:-5,  desc:'Sunny' },
      { day:'Fri', icon:'🌨', snow:6,  high:-3, low:-8,  desc:'Snow' },
    ],
    weeklySnow: [8, 12, 2, 0, 6, 8, 10],
    website: 'https://www.galaresort.jp',
    notes: 'The only ski resort with a direct Shinkansen station. 75 min from Tokyo Station. Ideal Tokyo day trip.',
  },
  {
    id: 23, rank: '#23',
    name: 'Joetsu Kokusai', nameJP: '上越国際スキー場',
    region: 'honshu', prefecture: 'Niigata',
    lat: 37.0000, lon: 138.7200,
    elevation: { base: 180, summit: 1040 },
    photo: '',
    bgGradient: 'linear-gradient(135deg,#051020,#0a2030)',
    stats: {
      baseDepth: 120, summit48h: 25, base48h: 20,
      openRuns: 30, totalRuns: 32,
      lifts: { open: 18, total: 21 },
      condition: 'Packed Powder', windKph: 20, visibility: 'Moderate', tempC: -6
    },
    forecast: [
      { day:'Mon', icon:'🌨', snow:10, high:-4, low:-9,  desc:'Snow' },
      { day:'Tue', icon:'🌨', snow:16, high:-5, low:-10, desc:'Heavy snow' },
      { day:'Wed', icon:'❄️', snow:6,  high:-4, low:-9,  desc:'Snow showers' },
      { day:'Thu', icon:'⛅', snow:1,  high:-2, low:-7,  desc:'Partly cloudy' },
      { day:'Fri', icon:'🌨', snow:8,  high:-4, low:-9,  desc:'Snow' },
    ],
    weeklySnow: [10, 16, 6, 1, 8, 12, 5],
    website: 'https://www.princehotels.com/joetsu-kokusai',
    notes: 'One of Niigata\'s largest resorts. Massive snowfall from Japan Sea weather systems. Great for beginners and families.',
  },
  {
    id: 24, rank: '#24',
    name: 'Moiwa', nameJP: 'モイワスキーリゾート',
    region: 'hokkaido', prefecture: 'Hokkaido',
    lat: 42.7720, lon: 140.7000,
    elevation: { base: 280, summit: 760 },
    photo: '',
    bgGradient: 'linear-gradient(135deg,#101830,#1a2548)',
    stats: {
      baseDepth: 180, summit48h: 55, base48h: 46,
      openRuns: 10, totalRuns: 12,
      lifts: { open: 4, total: 5 },
      condition: 'Powder', windKph: 10, visibility: 'Excellent', tempC: -10
    },
    forecast: [
      { day:'Mon', icon:'🌨', snow:24, high:-8,  low:-14, desc:'Heavy powder' },
      { day:'Tue', icon:'❄️', snow:16, high:-9,  low:-15, desc:'Snow' },
      { day:'Wed', icon:'☀️', snow:0,  high:-7,  low:-13, desc:'Clear' },
      { day:'Thu', icon:'🌨', snow:20, high:-9,  low:-15, desc:'Snow' },
      { day:'Fri', icon:'⛅', snow:5,  high:-7,  low:-13, desc:'Partly cloudy' },
    ],
    weeklySnow: [24, 16, 0, 20, 5, 18, 12],
    website: 'https://www.moiwa.co.jp',
    notes: 'Hidden gem minutes from Niseko. Small, peaceful resort with incredible Niseko-quality powder but far fewer crowds.',
  },
  {
    id: 25, rank: '#25',
    name: 'Tsugaike Kogen', nameJP: '栂池高原スキー場',
    region: 'honshu', prefecture: 'Nagano',
    ...
    stats: {
      ...
      openRuns: 21, totalRuns: 22,
      lifts: { open: 12, total: 14 },
      condition: 'Packed Powder', windKph: 16, visibility: 'Good', tempC: -8
    },
    forecast: [
      { day:'Mon', icon:'🌨', snow:10, high:-6, low:-12, desc:'Snow' },
      { day:'Tue', icon:'🌨', snow:16, high:-7, low:-13, desc:'Heavy snow' },
      { day:'Wed', icon:'⛅', snow:3,  high:-5, low:-11, desc:'Clearing' },
      { day:'Thu', icon:'☀️', snow:0,  high:-3, low:-9,  desc:'Sunny' },
      { day:'Fri', icon:'🌨', snow:8,  high:-6, low:-12, desc:'Snow' },
    ],
    weeklySnow: [10, 16, 3, 0, 8, 12, 6],
    website: 'https://tsugaike.co.jp',
    notes: 'Part of Hakuba Valley. Wide-open terrain popular with families. Great freeride terrain above the gondola.',
  },
  {
    id: 26, rank: '#26',
    name: 'Happo-one', nameJP: '八方尾根スキー場',
    region: 'honshu', prefecture: 'Nagano',
    ...
    stats: {
      ...
      openRuns: 13, totalRuns: 14,
      lifts: { open: 20, total: 23 },
      condition: 'Packed Powder', windKph: 28, visibility: 'Moderate', tempC: -7
    },
    forecast: [
      { day:'Mon', icon:'🌨', snow:12, high:-5, low:-11, desc:'Snow' },
      { day:'Tue', icon:'🌨', snow:20, high:-6, low:-12, desc:'Heavy snow' },
      { day:'Wed', icon:'❄️', snow:8,  high:-5, low:-11, desc:'Snow showers' },
      { day:'Thu', icon:'⛅', snow:2,  high:-3, low:-9,  desc:'Clearing' },
      { day:'Fri', icon:'☀️', snow:0,  high:-1, low:-7,  desc:'Sunny' },
    ],
    weeklySnow: [12, 20, 8, 2, 0, 10, 15],
    website: 'https://www.happo-one.jp',
    notes: 'Hakuba\'s flagship resort. 1998 Olympic downhill venue. Japan\'s most challenging groomed runs and epic alpine terrain.',
  },
  {
    id: 27, rank: '#27',
    name: 'Kamui Ski Links', nameJP: 'カムイスキーリンクス',
    region: 'hokkaido', prefecture: 'Hokkaido',
    lat: 43.8200, lon: 142.4000,
    elevation: { base: 240, summit: 670 },
    photo: '',
    bgGradient: 'linear-gradient(135deg,#05101e,#0c1f38)',
    stats: {
      baseDepth: 150, summit48h: 40, base48h: 32,
      openRuns: 15, totalRuns: 16,
      lifts: { open: 8, total: 9 },
      condition: 'Powder', windKph: 12, visibility: 'Excellent', tempC: -12
    },
    forecast: [
      { day:'Mon', icon:'🌨', snow:20, high:-10, low:-16, desc:'Heavy powder' },
      { day:'Tue', icon:'❄️', snow:14, high:-11, low:-17, desc:'Snow' },
      { day:'Wed', icon:'☀️', snow:0,  high:-9,  low:-15, desc:'Clear & cold' },
      { day:'Thu', icon:'🌨', snow:16, high:-11, low:-17, desc:'Snow showers' },
      { day:'Fri', icon:'⛅', snow:4,  high:-9,  low:-15, desc:'Partly cloudy' },
    ],
    weeklySnow: [20, 14, 0, 16, 4, 18, 10],
    website: 'https://www.kamui-skilinks.com',
    notes: 'Near Asahikawa city with excellent transit links. Receives heavy inland Hokkaido snowfall. Well-priced day tickets.',
  },
  {
    id: 28, rank: '#28',
    name: 'Akakura Kanko', nameJP: '赤倉観光リゾートスキー場',
    region: 'honshu', prefecture: 'Niigata',
    ...
    stats: {
      ...
      openRuns: 18, totalRuns: 20,
      lifts: { open: 8, total: 9 },
      condition: 'Packed Powder', windKph: 14, visibility: 'Good', tempC: -9
    },
    forecast: [
      { day:'Mon', icon:'🌨', snow:18, high:-7, low:-13, desc:'Snow' },
      { day:'Tue', icon:'🌨', snow:24, high:-8, low:-14, desc:'Heavy snow' },
      { day:'Wed', icon:'❄️', snow:10, high:-6, low:-12, desc:'Snow showers' },
      { day:'Thu', icon:'⛅', snow:2,  high:-4, low:-10, desc:'Partly cloudy' },
      { day:'Fri', icon:'🌨', snow:12, high:-7, low:-13, desc:'Snow' },
    ],
    weeklySnow: [18, 24, 10, 2, 12, 6, 20],
    website: 'https://www.akakura.gr.jp',
    notes: 'One of the oldest resorts in the Myoko area. Historic hot spring town at the base. Heavy Japan Sea snowfall.',
  },
  {
    id: 29, rank: '#29',
    name: 'Mt. Rokko Snow Park', nameJP: '六甲山スノーパーク',
    region: 'honshu', prefecture: 'Hyogo',
    lat: 34.7700, lon: 135.2500,
    elevation: { base: 880, summit: 931 },
    photo: '',
    bgGradient: 'linear-gradient(135deg,#1a1a0a,#2e2e10)',
    stats: {
      baseDepth: 30, summit48h: 8, base48h: 6,
      openRuns: 5, totalRuns: 5,
      lifts: { open: 3, total: 4 },
      condition: 'Groomed', windKph: 25, visibility: 'Moderate', tempC: -2
    },
    forecast: [
      { day:'Mon', icon:'❄️', snow:5,  high:-1, low:-4, desc:'Light snow' },
      { day:'Tue', icon:'🌨', snow:8,  high:-2, low:-5, desc:'Snow' },
      { day:'Wed', icon:'⛅', snow:1,  high:0,  low:-3, desc:'Partly cloudy' },
      { day:'Thu', icon:'☀️', snow:0,  high:2,  low:-1, desc:'Clear' },
      { day:'Fri', icon:'⛅', snow:2,  high:0,  low:-2, desc:'Partly cloudy' },
    ],
    weeklySnow: [5, 8, 1, 0, 2, 4, 3],
    website: 'https://www.rokkosan.com/snow',
    notes: 'Overlooking Kobe and Osaka Bay. The most accessible ski area from Kansai cities. Night skiing with city light views.',
  },
  {
    id: 30, rank: '#30',
    name: 'Biwako Valley', nameJP: 'びわ湖バレイスキー場',
    region: 'honshu', prefecture: 'Shiga',
    lat: 35.1900, lon: 135.9600,
    elevation: { base: 400, summit: 1108 },
    photo: '',
    bgGradient: 'linear-gradient(135deg,#0a1c2e,#10283e)',
    stats: {
      baseDepth: 55, summit48h: 12, base48h: 8,
      openRuns: 8, totalRuns: 10,
      lifts: { open: 3, total: 5 },
      condition: 'Groomed', windKph: 30, visibility: 'Poor', tempC: -3
    },
    forecast: [
      { day:'Mon', icon:'❄️', snow:6,  high:-1, low:-5, desc:'Snow showers' },
      { day:'Tue', icon:'🌨', snow:10, high:-2, low:-6, desc:'Snow' },
      { day:'Wed', icon:'⛅', snow:2,  high:0,  low:-4, desc:'Partly cloudy' },
      { day:'Thu', icon:'☀️', snow:0,  high:2,  low:-2, desc:'Clear' },
      { day:'Fri', icon:'❄️', snow:4,  high:-1, low:-4, desc:'Light snow' },
    ],
    weeklySnow: [6, 10, 2, 0, 4, 6, 5],
    website: 'https://www.biwako-valley.com',
    notes: 'Spectacular gondola with panoramic views of Lake Biwa. Closest ski resort to Kyoto and Osaka. Strong wind is common.',
  },
  {
    id: 31, rank: '#31',
    name: 'Tenjindaira', nameJP: '天神平スキー場',
    region: 'honshu', prefecture: 'Gunma',
    lat: 36.8400, lon: 138.9400,
    elevation: { base: 746, summit: 1502 },
    photo: '',
    bgGradient: 'linear-gradient(135deg,#1a0a2a,#28103e)',
    stats: {
      baseDepth: 100, summit48h: 20, base48h: 16,
      openRuns: 5, totalRuns: 5,
      lifts: { open: 2, total: 3 },
      condition: 'Packed Powder', windKph: 40, visibility: 'Poor', tempC: -8
    },
    forecast: [
      { day:'Mon', icon:'🌨', snow:12, high:-6, low:-12, desc:'Snow' },
      { day:'Tue', icon:'🌨', snow:18, high:-7, low:-13, desc:'Heavy snow' },
      { day:'Wed', icon:'❄️', snow:8,  high:-6, low:-12, desc:'Snow showers' },
      { day:'Thu', icon:'⛅', snow:2,  high:-4, low:-10, desc:'Partly cloudy' },
      { day:'Fri', icon:'🌨', snow:10, high:-6, low:-12, desc:'Snow' },
    ],
    weeklySnow: [12, 18, 8, 2, 10, 6, 14],
    website: 'https://www.tanigawadake-rw.co.jp',
    notes: 'Reached by the famous Tanigawadake ropeway. Top of the ropeway is a launch pad for epic off-piste skiing. High avalanche risk — experts only.',
  },
  {
    id: 32, rank: '#32',
    name: 'Karuizawa Prince', nameJP: '軽井沢プリンスホテルスキー場',
    region: 'honshu', prefecture: 'Nagano',
    ...
    stats: {
      ...
      openRuns: 19, totalRuns: 19,
      lifts: { open: 8, total: 8 },
      condition: 'Groomed', windKph: 12, visibility: 'Excellent', tempC: -4
    },
    forecast: [
      { day:'Mon', icon:'❄️', snow:3,  high:-2, low:-7, desc:'Light snow' },
      { day:'Tue', icon:'🌨', snow:8,  high:-3, low:-8, desc:'Snow' },
      { day:'Wed', icon:'⛅', snow:1,  high:-1, low:-6, desc:'Partly cloudy' },
      { day:'Thu', icon:'☀️', snow:0,  high:1,  low:-4, desc:'Sunny' },
      { day:'Fri', icon:'❄️', snow:4,  high:-2, low:-7, desc:'Light snow' },
    ],
    weeklySnow: [3, 8, 1, 0, 4, 5, 2],
    website: 'https://www.princehotels.com/karuizawa',
    notes: 'Japan\'s most snow-making resort. 100% snow-making coverage. 60 min from Tokyo. Beginner and family friendly.',
  },
  {
    id: 33, rank: '#33',
    name: 'Sugadaira Kogen', nameJP: '菅平高原スノーリゾート',
    region: 'honshu', prefecture: 'Nagano',
    ...
    stats: {
      ...
      openRuns: 25, totalRuns: 28,
      lifts: { open: 14, total: 16 },
      condition: 'Groomed', windKph: 18, visibility: 'Good', tempC: -9
    },
    forecast: [
      { day:'Mon', icon:'❄️', snow:8,  high:-7, low:-13, desc:'Snow showers' },
      { day:'Tue', icon:'🌨', snow:12, high:-8, low:-14, desc:'Snow' },
      { day:'Wed', icon:'⛅', snow:3,  high:-6, low:-12, desc:'Partly cloudy' },
      { day:'Thu', icon:'☀️', snow:0,  high:-4, low:-10, desc:'Sunny' },
      { day:'Fri', icon:'🌨', snow:8,  high:-7, low:-13, desc:'Snow' },
    ],
    weeklySnow: [8, 12, 3, 0, 8, 5, 10],
    website: 'https://www.sugadaira.co.jp',
    notes: 'High-altitude plateau with multiple linked ski areas. Consistent natural snow. Popular sports training venue in summer.',
  },
  {
    id: 34, rank: '#34',
    name: 'Shizukuishi', nameJP: 'しずくいしスキー場',
    region: 'honshu', prefecture: 'Iwate',
    ...
    stats: {
      ...
      openRuns: 16, totalRuns: 18,
      lifts: { open: 8, total: 9 },
      condition: 'Groomed', windKph: 12, visibility: 'Good', tempC: -6
    },
    forecast: [
      { day:'Mon', icon:'⛅', snow:5,  high:-4, low:-9,  desc:'Light snow' },
      { day:'Tue', icon:'🌨', snow:10, high:-5, low:-10, desc:'Snow' },
      { day:'Wed', icon:'❄️', snow:6,  high:-4, low:-9,  desc:'Snow showers' },
      { day:'Thu', icon:'☀️', snow:0,  high:-2, low:-7,  desc:'Clear' },
      { day:'Fri', icon:'⛅', snow:3,  high:-3, low:-8,  desc:'Partly cloudy' },
    ],
    weeklySnow: [5, 10, 6, 0, 3, 7, 8],
    website: 'https://www.shizukuishi-ski.com',
    notes: 'At the foot of Mt. Iwate (2038m). Prince Hotel resort with well-groomed runs. Reliable Tohoku snowfall, quieter than Appi.',
  },
  {
    id: 35, rank: '#35',
    name: 'Hachimantai', nameJP: '八幡平スキー場',
    region: 'honshu', prefecture: 'Akita',
    ...
    stats: {
      ...
      openRuns: 10, totalRuns: 12,
      lifts: { open: 4, total: 5 },
      condition: 'Packed Powder', windKph: 22, visibility: 'Moderate', tempC: -10
    },
    forecast: [
      { day:'Mon', icon:'🌨', snow:14, high:-8,  low:-14, desc:'Snow' },
      { day:'Tue', icon:'🌨', snow:18, high:-9,  low:-15, desc:'Heavy snow' },
      { day:'Wed', icon:'❄️', snow:8,  high:-7,  low:-13, desc:'Snow showers' },
      { day:'Thu', icon:'⛅', snow:2,  high:-5,  low:-11, desc:'Partly cloudy' },
      { day:'Fri', icon:'🌨', snow:10, high:-8,  low:-14, desc:'Snow' },
    ],
    weeklySnow: [14, 18, 8, 2, 10, 6, 16],
    website: 'https://hachimantai-ski.jp',
    notes: 'Volcanic plateau on the Akita-Iwate border. Deep backcountry powder. Remote and uncrowded with classic Tohoku charm.',
  },
  {
    id: 36, rank: '#36',
    name: 'Inawashiro', nameJP: 'いなわしろスキー場',
    region: 'honshu', prefecture: 'Fukushima',
    lat: 37.5600, lon: 140.0700,
    elevation: { base: 600, summit: 1350 },
    photo: '',
    bgGradient: 'linear-gradient(135deg,#1e1000,#342000)',
    stats: {
      baseDepth: 90, summit48h: 18, base48h: 14,
      openRuns: 22, totalRuns: 24,
      lifts: { open: 10, total: 11 },
      condition: 'Groomed', windKph: 16, visibility: 'Good', tempC: -7
    },
    forecast: [
      { day:'Mon', icon:'🌨', snow:8,  high:-5, low:-10, desc:'Snow' },
      { day:'Tue', icon:'🌨', snow:14, high:-6, low:-11, desc:'Heavy snow' },
      { day:'Wed', icon:'⛅', snow:3,  high:-4, low:-9,  desc:'Clearing' },
      { day:'Thu', icon:'☀️', snow:0,  high:-2, low:-7,  desc:'Sunny' },
      { day:'Fri', icon:'❄️', snow:6,  high:-4, low:-9,  desc:'Snow showers' },
    ],
    weeklySnow: [8, 14, 3, 0, 6, 10, 5],
    website: 'https://www.inawashiro-ski.com',
    notes: 'Views of Mount Bandai and Lake Inawashiro. Good variety of runs on volcanic slopes. Well-priced and family-friendly.',
  },
  {
    id: 37, rank: '#37',
    name: 'Tsunan', nameJP: '津南スキー場',
    region: 'honshu', prefecture: 'Niigata',
    lat: 36.8800, lon: 138.6000,
    elevation: { base: 340, summit: 900 },
    photo: '',
    bgGradient: 'linear-gradient(135deg,#0d1a2e,#162540)',
    stats: {
      baseDepth: 200, summit48h: 55, base48h: 45,
      openRuns: 12, totalRuns: 12,
      lifts: { open: 7, total: 7 },
      condition: 'Powder', windKph: 10, visibility: 'Good', tempC: -8
    },
    forecast: [
      { day:'Mon', icon:'🌨', snow:28, high:-6, low:-11, desc:'Heavy powder' },
      { day:'Tue', icon:'🌨', snow:22, high:-7, low:-12, desc:'Snow' },
      { day:'Wed', icon:'❄️', snow:12, high:-5, low:-10, desc:'Snow showers' },
      { day:'Thu', icon:'⛅', snow:2,  high:-3, low:-8,  desc:'Partly cloudy' },
      { day:'Fri', icon:'🌨', snow:18, high:-6, low:-11, desc:'Snow' },
    ],
    weeklySnow: [28, 22, 12, 2, 18, 8, 24],
    website: 'https://www.tsunan-ski.com',
    notes: 'One of Japan\'s snowiest low-elevation resorts. Snow depth often exceeds 3m. Quiet backcountry feel in Niigata\'s snow country.',
  },
  {
    id: 38, rank: '#38',
    name: 'Hunter Mountain', nameJP: 'ハンターマウンテン塩原',
    ...
    stats: {
      ...
      openRuns: 18, totalRuns: 20,
      lifts: { open: 8, total: 9 },
      condition: 'Groomed', windKph: 14, visibility: 'Good', tempC: -4
    },
    forecast: [
      { day:'Mon', icon:'❄️', snow:5,  high:-2, low:-7, desc:'Light snow' },
      { day:'Tue', icon:'🌨', snow:10, high:-3, low:-8, desc:'Snow' },
      { day:'Wed', icon:'⛅', snow:2,  high:-1, low:-6, desc:'Partly cloudy' },
      { day:'Thu', icon:'☀️', snow:0,  high:1,  low:-4, desc:'Sunny' },
      { day:'Fri', icon:'❄️', snow:4,  high:-2, low:-7, desc:'Light snow' },
    ],
    weeklySnow: [5, 10, 2, 0, 4, 8, 3],
    website: 'https://www.huntermountain.co.jp',
    notes: 'Closest large ski resort to central Tokyo (2.5h). Night skiing available. Popular with city skiers heading for a quick powder fix.',
  },
  {
    id: 39, rank: '#39',
    name: 'Nasu Kogen', nameJP: '那須高原スキー場',
    region: 'honshu', prefecture: 'Tochigi',
    lat: 37.1200, lon: 139.9700,
    elevation: { base: 750, summit: 1230 },
    photo: '',
    bgGradient: 'linear-gradient(135deg,#0a1a1e,#102430)',
    stats: {
      baseDepth: 45, summit48h: 8, base48h: 6,
      openRuns: 10, totalRuns: 12,
      lifts: { open: 5, total: 6 },
      condition: 'Groomed', windKph: 20, visibility: 'Moderate', tempC: -3
    },
    forecast: [
      { day:'Mon', icon:'❄️', snow:4,  high:-1, low:-6, desc:'Light snow' },
      { day:'Tue', icon:'🌨', snow:8,  high:-2, low:-7, desc:'Snow' },
      { day:'Wed', icon:'⛅', snow:1,  high:0,  low:-5, desc:'Partly cloudy' },
      { day:'Thu', icon:'☀️', snow:0,  high:2,  low:-3, desc:'Sunny' },
      { day:'Fri', icon:'❄️', snow:3,  high:-1, low:-6, desc:'Light snow' },
    ],
    weeklySnow: [4, 8, 1, 0, 3, 5, 2],
    website: 'https://www.nasukogen-ski.com',
    notes: 'At the foot of Mt. Chausu volcano. Popular hot spring resort town. Easy access from Tokyo via Shinkansen to Nasushiobara.',
  },
  {
    id: 40, rank: '#40',
    name: 'Ontake', nameJP: 'おんたけ2240スキー場',
    region: 'honshu', prefecture: 'Nagano',
    ...
    stats: {
      ...
      openRuns: 14, totalRuns: 16,
      lifts: { open: 6, total: 8 },
      condition: 'Groomed', windKph: 25, visibility: 'Moderate', tempC: -10
    },
    forecast: [
      { day:'Mon', icon:'🌨', snow:10, high:-8, low:-14, desc:'Snow' },
      { day:'Tue', icon:'❄️', snow:8,  high:-9, low:-15, desc:'Snow showers' },
      { day:'Wed', icon:'⛅', snow:2,  high:-7, low:-13, desc:'Partly cloudy' },
      { day:'Thu', icon:'☀️', snow:0,  high:-5, low:-11, desc:'Clear' },
      { day:'Fri', icon:'🌨', snow:6,  high:-8, low:-14, desc:'Snow' },
    ],
    weeklySnow: [10, 8, 2, 0, 6, 8, 4],
    website: 'https://www.ontake2240.jp',
    notes: 'On the slopes of Mt. Ontake volcano (3067m). Japan\'s highest lifts. Good spring skiing well into April. Historic volcanic area.',
  },
  {
    id: 41, rank: '#41',
    name: 'Takasu Snow Park', nameJP: '高鷲スノーパーク',
    region: 'honshu', prefecture: 'Gifu',
    lat: 35.8300, lon: 136.9700,
    elevation: { base: 890, summit: 1550 },
    photo: '',
    bgGradient: 'linear-gradient(135deg,#1a1220,#281a32)',
    stats: {
      baseDepth: 80, summit48h: 15, base48h: 12,
      openRuns: 14, totalRuns: 16,
      lifts: { open: 7, total: 8 },
      condition: 'Groomed', windKph: 16, visibility: 'Good', tempC: -5
    },
    forecast: [
      { day:'Mon', icon:'🌨', snow:8,  high:-3, low:-8, desc:'Snow' },
      { day:'Tue', icon:'🌨', snow:12, high:-4, low:-9, desc:'Heavy snow' },
      { day:'Wed', icon:'⛅', snow:2,  high:-2, low:-7, desc:'Clearing' },
      { day:'Thu', icon:'☀️', snow:0,  high:0,  low:-5, desc:'Sunny' },
      { day:'Fri', icon:'❄️', snow:5,  high:-3, low:-8, desc:'Light snow' },
    ],
    weeklySnow: [8, 12, 2, 0, 5, 8, 4],
    website: 'https://www.takasu.co.jp',
    notes: 'Large Gifu resort with excellent variety. Hida Oku-Mino area known for heavy snowfall. Good access from Nagoya via express bus.',
  },
  {
    id: 42, rank: '#42',
    name: 'Dynaland', nameJP: 'ダイナランドスキー場',
    region: 'honshu', prefecture: 'Gifu',
    lat: 35.8500, lon: 136.9900,
    elevation: { base: 800, summit: 1400 },
    photo: '',
    bgGradient: 'linear-gradient(135deg,#1a0a10,#2a1018)',
    stats: {
      baseDepth: 75, summit48h: 14, base48h: 10,
      openRuns: 12, totalRuns: 14,
      lifts: { open: 6, total: 7 },
      condition: 'Groomed', windKph: 14, visibility: 'Good', tempC: -4
    },
    forecast: [
      { day:'Mon', icon:'🌨', snow:7,  high:-2, low:-7, desc:'Snow' },
      { day:'Tue', icon:'🌨', snow:11, high:-3, low:-8, desc:'Heavy snow' },
      { day:'Wed', icon:'⛅', snow:2,  high:-1, low:-6, desc:'Partly cloudy' },
      { day:'Thu', icon:'☀️', snow:0,  high:1,  low:-4, desc:'Sunny' },
      { day:'Fri', icon:'❄️', snow:4,  high:-2, low:-7, desc:'Light snow' },
    ],
    weeklySnow: [7, 11, 2, 0, 4, 7, 3],
    website: 'https://www.dynaland.co.jp',
    notes: 'Adjacent to Takasu Snow Park, sharing the same mountain. Night skiing and illumination events. Gifu\'s most popular resort.',
  },
  {
    id: 43, rank: '#43',
    name: 'Pippu', nameJP: 'ぴっぷスキー場',
    region: 'hokkaido', prefecture: 'Hokkaido',
    lat: 44.0100, lon: 142.4700,
    elevation: { base: 250, summit: 660 },
    photo: '',
    bgGradient: 'linear-gradient(135deg,#071020,#0e1c36)',
    stats: {
      baseDepth: 140, summit48h: 35, base48h: 28,
      openRuns: 12, totalRuns: 12,
      lifts: { open: 5, total: 5 },
      condition: 'Packed Powder', windKph: 8, visibility: 'Excellent', tempC: -13
    },
    forecast: [
      { day:'Mon', icon:'🌨', snow:18, high:-11, low:-17, desc:'Heavy powder' },
      { day:'Tue', icon:'❄️', snow:12, high:-12, low:-18, desc:'Snow' },
      { day:'Wed', icon:'☀️', snow:0,  high:-10, low:-16, desc:'Clear & cold' },
      { day:'Thu', icon:'🌨', snow:14, high:-12, low:-18, desc:'Snow showers' },
      { day:'Fri', icon:'⛅', snow:4,  high:-10, low:-16, desc:'Partly cloudy' },
    ],
    weeklySnow: [18, 12, 0, 14, 4, 16, 8],
    website: 'https://www.pippu-ski.jp',
    notes: 'Small local resort north of Asahikawa. Extremely light, dry powder. Almost entirely free of foreign tourists. Hidden Hokkaido gem.',
  },
  {
    id: 44, rank: '#44',
    name: 'Hanazono', nameJP: 'ハナゾノスキーリゾート',
    region: 'hokkaido', prefecture: 'Hokkaido',
    ...
    stats: {
      ...
      openRuns: 14, totalRuns: 14,
      lifts: { open: 4, total: 4 },
      condition: 'Powder', windKph: 12, visibility: 'Excellent', tempC: -10
    },
    forecast: [
      { day:'Mon', icon:'🌨', snow:30, high:-8,  low:-14, desc:'Heavy powder' },
      { day:'Tue', icon:'🌨', snow:25, high:-9,  low:-15, desc:'Snow' },
      { day:'Wed', icon:'❄️', snow:12, high:-7,  low:-13, desc:'Snow showers' },
      { day:'Thu', icon:'⛅', snow:3,  high:-5,  low:-11, desc:'Partly cloudy' },
      { day:'Fri', icon:'🌨', snow:22, high:-8,  low:-14, desc:'Snow' },
    ],
    weeklySnow: [30, 25, 12, 3, 22, 18, 28],
    website: 'https://www.hanazonoresort.com',
    notes: 'The powder-focused zone of Niseko United. Tree skiing heaven. Receives the same legendary Niseko snowfall in a quieter setting.',
  },
  {
    id: 45, rank: '#45',
    name: 'Seki Onsen', nameJP: '関温泉スキー場',
    region: 'honshu', prefecture: 'Niigata',
    lat: 36.9200, lon: 138.1200,
    elevation: { base: 770, summit: 1200 },
    photo: '',
    bgGradient: 'linear-gradient(135deg,#1e0a1e,#2e0f2e)',
    stats: {
      baseDepth: 220, summit48h: 62, base48h: 52,
      openRuns: 6, totalRuns: 6,
      lifts: { open: 2, total: 3 },
      condition: 'Powder', windKph: 8, visibility: 'Good', tempC: -12
    },
    forecast: [
      { day:'Mon', icon:'🌨', snow:35, high:-10, low:-16, desc:'Extreme powder' },
      { day:'Tue', icon:'🌨', snow:28, high:-11, low:-17, desc:'Heavy snow' },
      { day:'Wed', icon:'❄️', snow:15, high:-9,  low:-15, desc:'Snow' },
      { day:'Thu', icon:'⛅', snow:3,  high:-7,  low:-13, desc:'Partly cloudy' },
      { day:'Fri', icon:'🌨', snow:20, high:-10, low:-16, desc:'Snow' },
    ],
    weeklySnow: [35, 28, 15, 3, 20, 12, 38],
    website: 'https://www.sekionsen.jp',
    notes: 'One of Myoko\'s most legendary spots. Tiny, ungroomed resort with world-class deep powder. Purist\'s paradise. Often the deepest snow in the Myoko area.',
  },
  {
    id: 46, rank: '#46',
    name: 'Ikenotaira Onsen', nameJP: '池の平温泉スキー場',
    region: 'honshu', prefecture: 'Niigata',
    ...
    stats: {
      ...
      openRuns: 9, totalRuns: 9,
      lifts: { open: 5, total: 5 },
      condition: 'Powder', windKph: 10, visibility: 'Good', tempC: -11
    },
    forecast: [
      { day:'Mon', icon:'🌨', snow:24, high:-9,  low:-15, desc:'Heavy powder' },
      { day:'Tue', icon:'🌨', snow:20, high:-10, low:-16, desc:'Snow' },
      { day:'Wed', icon:'❄️', snow:10, high:-8,  low:-14, desc:'Snow showers' },
      { day:'Thu', icon:'⛅', snow:2,  high:-6,  low:-12, desc:'Partly cloudy' },
      { day:'Fri', icon:'🌨', snow:16, high:-9,  low:-15, desc:'Snow' },
    ],
    weeklySnow: [24, 20, 10, 2, 16, 8, 22],
    website: 'https://www.ikenotaira.co.jp',
    notes: 'Myoko area hot spring resort with excellent powder. Quieter alternative to the main Myoko resorts. Celebrated local onsen culture.',
  },
  {
    id: 47, rank: '#47',
    name: 'Aomori Spring', nameJP: 'アオモリスプリングスキーリゾート',
    region: 'honshu', prefecture: 'Aomori',
    lat: 40.5500, lon: 140.6200,
    elevation: { base: 300, summit: 983 },
    photo: '',
    bgGradient: 'linear-gradient(135deg,#10101e,#18183a)',
    stats: {
      baseDepth: 110, summit48h: 20, base48h: 16,
      openRuns: 12, totalRuns: 14,
      lifts: { open: 6, total: 7 },
      condition: 'Packed Powder', windKph: 15, visibility: 'Good', tempC: -7
    },
    forecast: [
      { day:'Mon', icon:'🌨', snow:10, high:-5, low:-10, desc:'Snow' },
      { day:'Tue', icon:'🌨', snow:14, high:-6, low:-11, desc:'Heavy snow' },
      { day:'Wed', icon:'❄️', snow:6,  high:-4, low:-9,  desc:'Snow showers' },
      { day:'Thu', icon:'☀️', snow:0,  high:-2, low:-7,  desc:'Clear' },
      { day:'Fri', icon:'⛅', snow:4,  high:-3, low:-8,  desc:'Partly cloudy' },
    ],
    weeklySnow: [10, 14, 6, 0, 4, 8, 6],
    website: 'https://www.aomorispring.jp',
    notes: 'Northern Honshu resort near the Lake Towada area. Known for great grooming and a relatively long season. Good all-round family resort.',
  },
  {
    id: 48, rank: '#48',
    name: 'Hakkoda', nameJP: '八甲田山スキー場',
    region: 'honshu', prefecture: 'Aomori',
    ...
    stats: {
      ...
      openRuns: 1, totalRuns: 1,
      lifts: { open: 1, total: 1 },
      condition: 'Powder', windKph: 35, visibility: 'Poor', tempC: -14
    },
    forecast: [
      { day:'Mon', icon:'🌨', snow:25, high:-12, low:-18, desc:'Heavy powder' },
      { day:'Tue', icon:'🌨', snow:30, high:-13, low:-19, desc:'Blizzard' },
      { day:'Wed', icon:'❄️', snow:18, high:-11, low:-17, desc:'Snow' },
      { day:'Thu', icon:'⛅', snow:5,  high:-9,  low:-15, desc:'Partly cloudy' },
      { day:'Fri', icon:'☀️', snow:0,  high:-8,  low:-14, desc:'Clear & cold' },
    ],
    weeklySnow: [25, 30, 18, 5, 0, 20, 35],
    website: 'https://www.hakkoda-ropeway.jp',
    notes: 'The ultimate Japanese off-piste experience. Single ropeway accesses vast unpatrolled backcountry. Shrine to deep powder skiing. Experts only.',
  },
  {
    id: 49, rank: '#49',
    name: 'Yubari Mount Racey', nameJP: '夕張マウントレースイスキー場',
    region: 'hokkaido', prefecture: 'Hokkaido',
    lat: 43.0700, lon: 141.9800,
    elevation: { base: 260, summit: 985 },
    photo: '',
    bgGradient: 'linear-gradient(135deg,#1a0a30,#240d42)',
    stats: {
      baseDepth: 130, summit48h: 30, base48h: 24,
      openRuns: 16, totalRuns: 18,
      lifts: { open: 5, total: 6 },
      condition: 'Packed Powder', windKph: 14, visibility: 'Good', tempC: -12
    },
    forecast: [
      { day:'Mon', icon:'🌨', snow:16, high:-10, low:-16, desc:'Snow' },
      { day:'Tue', icon:'❄️', snow:10, high:-11, low:-17, desc:'Snow showers' },
      { day:'Wed', icon:'☀️', snow:0,  high:-9,  low:-15, desc:'Clear' },
      { day:'Thu', icon:'🌨', snow:14, high:-11, low:-17, desc:'Snow' },
      { day:'Fri', icon:'⛅', snow:4,  high:-9,  low:-15, desc:'Partly cloudy' },
    ],
    weeklySnow: [16, 10, 0, 14, 4, 12, 8],
    website: 'https://www.yubari-racey.co.jp',
    notes: 'The former coal-mining town of Yubari\'s pride. Hokkaido inland powder. Affordable and uncrowded with classic backcountry feel.',
  },
  {
    id: 50, rank: '#50',
    name: 'Tokachidake Onsen', nameJP: '十勝岳温泉スキー場',
    region: 'hokkaido', prefecture: 'Hokkaido',
    lat: 43.5400, lon: 142.6900,
    elevation: { base: 1280, summit: 1950 },
    photo: '',
    bgGradient: 'linear-gradient(135deg,#0a0514,#100820)',
    stats: {
      baseDepth: 240, summit48h: 68, base48h: 58,
      openRuns: 2, totalRuns: 2,
      lifts: { open: 1, total: 1 },
      condition: 'Powder', windKph: 30, visibility: 'Poor', tempC: -18
    },
    forecast: [
      { day:'Mon', icon:'🌨', snow:38, high:-16, low:-22, desc:'Alpine blizzard' },
      { day:'Tue', icon:'🌨', snow:30, high:-17, low:-23, desc:'Heavy snow' },
      { day:'Wed', icon:'❄️', snow:18, high:-15, low:-21, desc:'Snow' },
      { day:'Thu', icon:'⛅', snow:5,  high:-13, low:-19, desc:'Partly cloudy' },
      { day:'Fri', icon:'☀️', snow:0,  high:-12, low:-18, desc:'Clear & bitter' },
    ],
    weeklySnow: [38, 30, 18, 5, 0, 22, 40],
    website: 'https://tokachidake-ski.jp',
    notes: 'Extreme high-altitude volcanic resort on Mt. Tokachidake. Opens October. Some of the coldest, driest powder in Hokkaido. Serious mountaineers only.',
  },
];
  ...
  const fetchAll = Promise.all(
    RESORTS.map(resort =>
      fetchResortWeather(resort, () => {
        loaded++;
        if (badge) badge.textContent = `⏳ ${loaded}/50 resorts…`;
      })
    )
  );
...
function renderSummary() {
  ...
  document.getElementById('resortsOpen').textContent  = open + '/50';
  ...
  document.getElementById('lastUpdated').textContent =
    `Live data (${live}/50 resorts) · ${formatDate()}`;

  // Show live/demo ratio badge
  const badge = document.getElementById('dataBadge');
  if (badge) {
    badge.textContent = live === 50 ? '🟢 All Live' : live > 0 ? `🟡 ${live}/50 Live` : '⚪ Demo Data';
  }
}
